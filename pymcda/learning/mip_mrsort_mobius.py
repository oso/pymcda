...
#                self.lp.set_error_stream(None)
    ...
    def add_constraints_cplex(self):
        ...
        for lc, v in self.lower_constraint.items():
            ...
            constraints.add(names = ["cxgamma_" + lc],
                            lin_expr =
                                [
                                 [["x" + lc] + ["gamma" + lc],
                                  [1, 1]]
        ...
        for uc, v in self.upper_constraint.items():
            # sum(m_j(a_i,b_h) - y_i <= lbda - delta
            ...
            constraints.add(names = ["cygamma_" + uc],
                            lin_expr =
                                [
                                 [["y" + uc] + ["gamma" + uc],
                                  [1, 1]]
    ...
    def add_objective_cplex(self):
        ...
        self.lp.objective.set_linear([("gamma" + i, 1)
                                      for i in self.aa_ori.keys()])
