...
#            elif self.aa_ori(a) > self.aa(a) and \
    ...
    def get_profile_limits(self, i):
        ...
        above = self.model.get_veto_profile_upper_limit(profiles[i])
        below = self.model.get_veto_profile_lower_limit(profiles[i])
...
if __name__ == "__main__":
    ...
    model = generate_random_mrsort_model_with_coalition_veto(5, 3, 1)
    model.veto_lbda = 0.2
