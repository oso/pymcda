...
class CriteriaSets(object):
    ...
    def from_xmcda(self, xmcda, id = None):
        ...
        tag_list = xmcda.iter('criteriaSet')
        for tag in tag_list:
...
class CriteriaSet(object):
    ...
    def from_xmcda(self, xmcda):
        ...
        tag_list = xmcda.iter('criterionID')
        for tag in tag_list:
...
class AlternativePerformances(McdaObject):
    ...
    def from_xmcda(self, xmcda, id = None):
        ...
        for tag in tag_list:
            ...
            crit_val = unmarshal(list(value)[0])
...
class Segment(McdaObject):
    ...
    def from_xmcda(self, xmcda, id = None):
        ...
        tag_list = list(xmcda.iter('point'))
        if len(tag_list) != 2:
